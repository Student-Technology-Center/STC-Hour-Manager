...
/*
  ...
  This file is responsible for handling the case where
  a user wishes to cover an entire shift that has already
  been given up.
*/
    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        ...
        <div id="content" class="animated bounceInUp col-sm-6 text-center" style="background-color: transparent;margin-top:45px;">
          ...
          echo "<form class=\"form-horizontal\" action=\"delete.php?id=$dID\" method=\"post\" name=\"entireHrsFrm\" id=\"entireHrsFrm\"
                 role=\"form\" onsubmit=\"return TimeCheck()\">   
                      ...
                      <input type=\"submit\" name=\"submit\" id=\"submit\" value=\"Claim Shift!\" class=\"btn btn-warning btn-lg\" style=\"margin-top:20px;margin-left:0px;\" />
                   </form>";
